...
public class PostgresVeritabani implements IVeritabani {
    ...
    public boolean baglan() {
        try {
            conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/AkilliCihaz", "postgres", "admin");
            if (conn != null) {
    ...
    public boolean kullaniciDogrula(String kullaniciAdi, String sifre) {
        try {
            ...
            String sql= "SELECT *  FROM \"kullanicilar\" WHERE \"username\"='"+ kullaniciAdi + "' AND \"password\"='"+ sifre + "';";
